var Mode2 = function(){
	...
	var isOutsideBottle1 = false;
	var isOutsideBottle2 = false;
	var isOutsideBottle3 = false;
	var isOutsideBottle4 = false;
	...
	this.init = function(){
		...
		$(".mode_instruction").html('Select and transfer two solutions to the test tube.').show();
	...
	this.arModeFunction = function() {
		...
		if( !collision( $("#bottle1"), $("#traceDiv") ) && filler1Obj.filled ){
			isOutsideBottle1 = true;		
		}
		
		if( !collision( $("#bottle2"), $("#traceDiv") ) && filler2Obj.filled ){
			isOutsideBottle2 = true;		
		}
		
		if( !collision( $("#bottle3"), $("#traceDiv") ) && filler3Obj.filled ){
			isOutsideBottle3 = true;		
		}
		
		if( !collision( $("#bottle4"), $("#traceDiv") ) && filler4Obj.filled ){
			isOutsideBottle4 = true;		
		}
		
		//console.log(isOutsideBottle1+" "+isOutsideBottle2+" "+isOutsideBottle3+" "+isOutsideBottle4);
		...
		if( collision( $("#traceDiv"), $("#filler1") ) && ( !filler2Obj.filled && !filler3Obj.filled && !filler4Obj.filled ) ) {
			if(isFillerCompleted_AR_1 || isAnimationRunning) return;
			collision_1 = true;
			curId_AR = "filler1";
		} else if( collision( $("#traceDiv"), $("#filler2") ) &&  ( !filler1Obj.filled && !filler3Obj.filled && !filler4Obj.filled ) ) {
			if(isFillerCompleted_AR_2 || isAnimationRunning) return;
			collision_2 = true;
			curId_AR = "filler2";
		} else 	if( collision( $("#traceDiv"), $("#filler3")) &&  ( !filler1Obj.filled && !filler2Obj.filled && !filler4Obj.filled ) ) {
			if(isFillerCompleted_AR_3 || isAnimationRunning) return;
			collision_3 = true;
			curId_AR = "filler3";
		} else 	if( collision( $("#traceDiv"), $("#filler4")) &&  ( !filler1Obj.filled && !filler2Obj.filled && !filler3Obj.filled ) ) {
			if(isFillerCompleted_AR_4 || isAnimationRunning) return;
			collision_4 = true;
			curId_AR = "filler4";
		}
		
		if( isOutsideBottle1 && collision( $("#bottle1"), $("#traceDiv") ) && filler1Obj.filled ){
			isOutsideBottle1 = false;
			collision_1 = false;
			curId_AR = "";
			...
			disableTimeOutID = setTimeout(function(){  },2000);
			//$("#traceDiv").width(0).height(0);
			console.log("isOutsideBottle1: "+isOutsideBottle1);
		}
		
		if( isOutsideBottle2 && collision( $("#bottle2"), $("#traceDiv") ) && filler2Obj.filled ){
			isOutsideBottle2 = false;
			collision_2 = false;
			curId_AR = "";	
			...
			//$("#traceDiv").width(0).height(0);
			console.log("isOutsideBottle2: "+isOutsideBottle2);
		}
		
		if( isOutsideBottle3 && collision( $("#bottle3"), $("#traceDiv") ) && filler3Obj.filled ){
			isOutsideBottle3 = false;
			collision_3 = false;
			curId_AR = "";
			...
			//$("#traceDiv").width(0).height(0);
			console.log("isOutsideBottle3: "+isOutsideBottle3);
		}
		
		if( isOutsideBottle4 && collision( $("#bottle4"), $("#traceDiv") ) && filler4Obj.filled ){
			isOutsideBottle4 = false;	
			collision_4 = false;
			curId_AR = "";
			...
			//$("#traceDiv").width(0).height(0);
			console.log("isOutsideBottle4: "+isOutsideBottle4);
		}
		...
		if(isFillerMouseDown && !isAnimationRunning){
			...
			if(!isFiller1Area){
					...
					if(condition1 && condition2 && condition3 && condition4){
						...
						if(isAndroid){
							var fixedLeft =  $("#testTube").position().left + 20;
							var fixedTop =   $("#testTube").position().top	- 63; 	
	...
	this.handleFiller1Tick = function(){
		...
		if(filler1Animation2.currentFrame == 57 || filler1Animation2.currentFrame == 58 || filler1Animation2.currentFrame == 56){
			...
			if(curAttempt == 0){
				...
				$(".mode_instruction").html('Transfer another solution to the test tube.').show();
				...
				$(".mode_instruction").html('Observe the change of the solutions.').show();
