...
function onImageLoad(){
		...
		$("#percentageVal").html( 'Loading '+ Math.round( curPercentage) + '%');
...
var updateInstruction = function(){
	if(cameraStatus){
		if(levelCount == 0){
			$('#info-text').html('Use the dropper to transfer required amount of solution from the reagent bottle to the beaker. Kindly use the right hand as the gesture to perform the simulation. For the best experience, Please put your hand before a plain white background. <br><br> To know more about the gesture, watch the demo video below.');
		}else if(levelCount == 1){
			$('#info-text').html('Transfer two solutions to the test tube to see what will happen when they are mixed. Kindly use the right hand as the gesture to perform the simulation. For the best experience, Please put your hand before a plain white background. <br><br> To know more about the gesture, watch the demo video below.');
		}else if(levelCount == 2){
			$('#info-text').html('Set up the apparatus to boil the water. You may open or close the air hole to adjust the Bunsen flame. Kindly use the right hand as the gesture to perform the simulation. For the best experience, Please put your hand before a plain white background. <br><br> To know more about the gesture, watch the demo video below.');
		}
	}else{
		if(levelCount == 0){
			$('#info-text').html('Use the dropper to transfer required amount of solution from the reagent bottle to the beaker.');
		}else if(levelCount == 1){
			$('#info-text').html('Transfer two solutions to the test tube to see what will happen when they are mixed.');
		}else if(levelCount == 2){
			$('#info-text').html('Set up the apparatus to boil the water. You may open or close the air hole to adjust the Bunsen flame.');
		}		
	}
}
		...
		try {
			...
			compatibility.getUserMedia({ audio:false, video: getVid }, function(stream) {
				try {
					...
					//$('#demoVid').show();
					$('#infoBanner').fadeIn();
					$('#info-text').html('Kindly use the right hand as the gesture to perform the simulation. For the best experience, Please put your hand before a plain white background. To know more about the gesture, watch the demo video below.');
